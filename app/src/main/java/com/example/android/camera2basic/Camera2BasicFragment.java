...
public class Camera2BasicFragment extends Fragment
    ...
    private void startBackgroundThread() {
        ...
        mBackgroundHandler2 = new Handler(mBackgroundThread2.getLooper()){
            ...
            try {
                mbarcodeReader.decodeBuffer(imageData.mBytes,imageData.mWidth,imageData.mHeight, imageData.mStride, EnumImagePixelFormat.IPF_NV21, "");
                TextResult[] result = mbarcodeReader.getAllTextResults();
